          ...
          {state === 'done' ? (
            ...
            <form className="panel" onSubmit={submit}>
              ...
              <p className="panel__muted" style={{ maxWidth: '56ch' }}>
                Paste any YouTube link: full videos, Shorts, share links, the lot. The feed runs
                on YouTube so hosting stays free and clips stay fast. Phone uploads, TikTok and
                console share all arrive with the app, where we post the clip to YouTube for you.
              </p>
